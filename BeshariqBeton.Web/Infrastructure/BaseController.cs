...
namespace BeshariqBeton.Web.Infrastructure
{
    ...
    {
        protected Common.Logging.ILogger Logger { get; set; }

        protected BaseController(Common.Logging.ILogger logger)
        {
            Logger = logger;
        }
        ...
        protected virtual IActionResult HandleException(Exception exception)
        {
            ...
            else if (exception is BetonException betonException)
